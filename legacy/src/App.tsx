            ...
            <div className="my-3 text-left">
              <label className="flex items-center gap-2 cursor-pointer text-xs text-stone-600 select-none bg-stone-50/80 p-2.5 rounded-lg border border-stone-200/80 hover:border-stone-300 transition-colors">
                ...
                <span className="text-[11px] leading-tight text-stone-700">
                  I accept the <a href="#" onClick={async (e) => { e.preventDefault(); await showDialog('alert', 'Security & Privacy Policy:\n\n• Your data is end-to-end encrypted.\n• We do not share your private notes or workspace data.\n• Cookies and sessions are strictly used for authorization.'); }} className="text-orange-600 underline font-semibold hover:text-orange-700">Security & Privacy Policy</a>
                </span>
              </label>
            </div>
